...
// Re-export from eggsplain-types so callers can use a single import path
pub use eggsplain_types::skill_types::{ContextModifier, effort_to_string};
...
mod tests {
    ...
    use eggsplain_types::skill_types::EffortLevel;
