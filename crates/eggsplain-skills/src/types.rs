...
// Re-export EffortLevel from eggsplain-types (single source of truth)
pub use eggsplain_types::skill_types::EffortLevel;
...
pub enum SkillSource {
    /// `<config_dir>/eggsplain/skills/`
    User,
    /// .eggsplain/skills/ (project-level)
    Project,
    /// .eggsplain/.managed/skills/
    Managed,
    /// Built-in bundled skills
    Bundled,
    /// Loaded via MCP protocol
    Mcp,
    /// .eggsplain/commands/ (legacy compatibility)
    Legacy,
}
