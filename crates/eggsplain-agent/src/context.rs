...
use eggsplain_memory::prompt::build_memory_prompt_minimal;
use eggsplain_skills::prompt::format_skills_within_budget;
use eggsplain_skills::types::SkillMetadata;
...
pub fn build_system_prompt(
    ...
    if toon_enabled {
        let toon_section = cache
            .sections
            .entry("toon")
            .or_insert_with(|| eggsplain_compact::toon_format_instructions().to_string());
