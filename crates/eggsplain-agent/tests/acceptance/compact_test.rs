...
use eggsplain_agent::compact::auto::{BOUNDARY_PREFIX, autocompact, should_autocompact};
use eggsplain_agent::compact::emergency::is_at_emergency_limit;
use eggsplain_agent::compact::micro::{CLEARED_TOOL_RESULT, microcompact};
use eggsplain_agent::compact::state::CompactState;
...
async fn autocompact_triggers_llm_summary() {
    ...
    let config = {
        ...
        eggsplain_config::config::Config {
    ...
    let provider = eggsplain_providers::create_provider(&config);
