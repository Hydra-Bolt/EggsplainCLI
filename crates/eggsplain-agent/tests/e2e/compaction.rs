...
use eggsplain_agent::confirm::ToolConfirmer;
use eggsplain_agent::engine::AgentEngine;
use eggsplain_agent::orchestration::execute_tool_calls;
use eggsplain_agent::output::OutputSink;
use eggsplain_agent::output::null_sink::NullSink;
use eggsplain_compact::CompactionLevel;
use eggsplain_config::compat::ProviderCompat;
use eggsplain_config::config::{Config, ProviderType, SessionConfig, ToolsConfig};
use eggsplain_config::hooks::HooksConfig;
use eggsplain_mcp::config::McpConfig;
use eggsplain_providers::create_provider;
...
fn openai_config(api_key: &str) -> Config {
    Config {
        ...
        tools: ToolsConfig {
            auto_approve: true,
            allow_list: vec![],
            skills: eggsplain_config::config::SkillsPermissionConfig::default(),
        },
        ...
        compact: eggsplain_config::compact::CompactConfig::default(),
        plan: eggsplain_config::plan::PlanConfig::default(),
        file_cache: eggsplain_config::file_cache::FileCacheConfig::default(),
        hooks: HooksConfig::default(),
        bedrock: None,
        vertex: None,
        mcp: McpConfig::default(),
        logging: eggsplain_config::logging::LoggingConfig::default(),
    }
}
...
impl eggsplain_tools::Tool for FixedOutputTool {
    fn name(&self) -> &str {
        &self.name
    }
    ...
    fn category(&self) -> eggsplain_protocol::events::ToolCategory {
        eggsplain_protocol::events::ToolCategory::Info
    }
    ...
    async fn execute(&self, _input: serde_json::Value) -> eggsplain_types::tool::ToolResult {
