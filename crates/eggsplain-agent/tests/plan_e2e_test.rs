...
use eggsplain_agent::plan::prompt::plan_mode_instructions;
use eggsplain_agent::plan::tools::{EnterPlanModeTool, ExitPlanModeTool};
use eggsplain_protocol::events::ToolCategory;
use eggsplain_tools::Tool;
use eggsplain_tools::registry::ToolRegistry;
use eggsplain_types::skill_types::PlanModeTransition;
...
fn tc_3_6_e2e_02_plan_mode_and_compaction_independent() {
    use eggsplain_agent::compact::micro::microcompact;
    use eggsplain_agent::plan::state::PlanState;
